...
const HistoricalChart = ({ currency, onClose }) => {
  ...
  const chartData = {
    ...
    datasets: [
      {
        label: `Exchange Rate for 1 AUD to ${currency}`,
  ...
  const chartOptions = {
    ...
    plugins: {
      ...
      title: {
        display: true,
        text: `Exchange Rate History for the Last 14 Days - AUD to ${currency}`,
        font: {
          size: 20,
        },
      },
    ...
    <div className="fixed inset-0 bg-gray-800 bg-opacity-75 flex items-center justify-center">
      <div className="bg-white p-8 rounded-lg shadow-lg max-w-4xl w-full">
        <h2 className="text-3xl mb-6 text-center">
          Past 14 Days Exchange Rate for AUD to {currency}
        </h2>
